import { Controller, Get, Inject, Param, ParseIntPipe, ParseUUIDPipe, UseGuards } from "@nestjs/common";
...
export class UsersProfileController {
  constructor(@Inject('USERS_PROFILE') private readonly useCase: UsersProfileAdaptor) {
  }
  ...
  private async profile(@Param("id", ParseUUIDPipe) id:string): Promise<UsersProfileAdaptorOutputDto> {
