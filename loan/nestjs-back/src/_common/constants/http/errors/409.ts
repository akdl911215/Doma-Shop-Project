...
export const ALREADY_LOAN_CREDITOR_UNIQUE_ID =
  "ALREADY_LOAN_CREDITOR_UNIQUE_ID";
export const ALREADY_LOAN_DEBTOR_UNIQUE_ID = "ALREADY_LOAN_DEBTOR_UNIQUE_ID";
export const ALREADY_LOAN_UNIQUE_ID = "ALREADY_LOAN_UNIQUE_ID";
