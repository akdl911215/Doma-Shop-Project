...
export interface LoansValidateRequiredLoanUniqueIdInterface {
    readonly validateRequiredLoanUniqueId: (dto: LoansValidateRequiredLoanUniqueIdInterfaceInputDto) => Promise<LoansValidateRequiredLoanUniqueIdInterfaceOutputDto>;
}
