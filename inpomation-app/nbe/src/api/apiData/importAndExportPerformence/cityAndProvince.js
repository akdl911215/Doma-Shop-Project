    ...
    parseString(body, (err, result) => {
      ...
      res.json({
        result: {
          ...
          cmtrBlncAmt: result.response.body[0].items[0].item[0].cmtrBlncAmt[0], // cmtrBlncAmt : 무역지수
          ...
          cmtrBlncAmt2: result.response.body[0].items[0].item[1].cmtrBlncAmt[0], // cmtrBlncAmt : 무역지수
